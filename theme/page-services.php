                        ...
                        <div class="carousel-cell rounded-[28px]" style="border-radius: 15px; padding: 10px; border: 1px solid #dfeae8;box-shadow:0 6px 20px rgba(0,0,0,.08); overflow:hidden;">
                            ...
                            <!-- </a>  -->
                                <div class="service-content font-title font-semibold text-xl">
                                    <h5 class="font-title font-semibold text-3xl md:text-4xl text-[#1f2b3a] mb-2 text-center">
                                        <?php echo $title; ?>
                                    </h5>
                                </div>
                            </div>
...
<section class="lg:py-10 py-5">
    <div class="max-w-screen-lg mx-auto px-4">
        ...
        <div class="lg:py-6 py-4 font-body text-lg leading-[2.2rem] text-center"><?php echo the_field('process_details'); ?></div>
        <div class="lg:py-6 py-4">
            <h2 class="font-title text-5xl md:text-4xl text-center"><?php echo esc_html( get_field('benefits_title') ); ?></h2>
        </div>
        <div class="lg:py-6 py-4">
            <div class="grid lg:grid-cols-2 grid-cols-1 gap-8">
                <div class="bg-[#f5f5f5] p-7 rounded-lg text-justify font-body text-lg leading-[2.2rem]" style="min-width: 280px;">
