...
?>
    ...
    <div class="hero-wrap absolute inset-0 w-full h-full grid place-items-center">
        <div class="font-title text-white container max-w-screen-xl lg:h-[20%] h-[30%] lg:w-2/4 w-[60%] grid place-items-center  mx-auto my-auto px-4 sm:px-2 border-t-2 border-b-2 border-white">
