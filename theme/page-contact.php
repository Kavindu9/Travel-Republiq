...
<script>window.umdRootPath="https://cdn.jotfor.ms/s/umd/83beb411155/"</script>
<script>window.staticRootPath="https://cdn.jotfor.ms/s/static/83beb411155/"</script>
<script src="https://cdn.jotfor.ms/s/static/83beb411155/secure-message-bus.js" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/s/static/83beb411155/static/prototype.forms.js" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/s/static/83beb411155/static/jotform.forms.js" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/s/static/83beb411155/js/punycode-1.4.1.min.js" type="text/javascript" defer></script>
<script src="https://cdn.jotfor.ms/s/static/83beb411155/js/vendor/maskedinput_5.0.9.min.js" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/s/static/83beb411155/js/dropdownV2.js" type="text/javascript" defer></script>
<script src="https://cdn.jotfor.ms/s/umd/83beb411155/for-aria-notify-polyfill.js" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/s/umd/83beb411155/for-form-field-tracker.js" type="text/javascript" defer></script>
<script src="https://cdn.jotfor.ms/s/umd/83beb411155/for-form-branding-footer.js" type="text/javascript" defer></script>
<script src="https://cdn.jotfor.ms/s/static/83beb411155/js/vendor/smoothscroll.min.js" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/s/static/83beb411155/js/errorNavigation.js" type="text/javascript"></script>
<script type="text/javascript">	JotForm.newDefaultTheme = true;
   ...
   JotForm.setConditions([{"action":[{"field":"9","visibility":"Show","id":"action_0_1579704830003"}],"id":"1579704830003","index":"0","isError":"1","link":"Any","priority":"0","terms":[{"field":"8","operator":"equals","value":"Other"}],"type":"field"}]);	JotForm.submitError="jumpToFirstError";
	window.addEventListener('DOMContentLoaded',function(){window.brandingFooter.init({"formID":262263209178459,"campaign":"powered_by_jotform_le","isCardForm":false,"isLegacyForm":true,"formLanguage":"en"})});	JotForm.isFullSource = true;
...
if (window.JotForm && JotForm.accessible) $('input_38').setAttribute('tabindex',0);
   ...
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,{"name":"clickTo","qid":"1","text":"Welcome Travel Republic Maldives","type":"control_head"},null,{"name":"fullName3","qid":"3","text":"Full Name","type":"control_fullname"},null,{"name":"phoneNumber5","qid":"5","text":"Phone Number With Country Code","type":"control_phone"},{"name":"email6","qid":"6","subLabel":"example@example.com","text":"E-mail","type":"control_email"},null,{"name":"howDid8","qid":"8","text":"Accommodation type","type":"control_dropdown"},null,null,null,null,null,null,null,{"name":"divider","qid":"16","text":"Divider","type":"control_divider"},null,null,null,null,null,null,null,null,{"name":"submit","qid":"25","text":"Submit Trip Request","type":"control_button"},null,null,null,{"name":"divider29","qid":"29","text":"Divider","type":"control_divider"},null,{"description":"","name":"typeA","qid":"31","subLabel":"Country","text":"Country \u002F Region","type":"control_textbox"},{"description":"","name":"date","qid":"32","text":"Travel Dates","type":"control_datetime"},{"description":"","name":"typeA33","qid":"33","subLabel":"Adults","text":"Number of Travelers","type":"control_dropdown"},{"description":"","name":"typeA34","qid":"34","subLabel":"Kids","text":"","type":"control_dropdown"},{"description":"","name":"typeA35","qid":"35","subLabel":"Kids Age (comma separated, e.g. 5,7,10)","text":"Kids Age","type":"control_textbox"},{"description":"","name":"typeA36","qid":"36","subLabel":"","text":"Meal Plan","type":"control_dropdown"},{"description":"","name":"typeA37","qid":"37","subLabel":"","text":"Budget range","type":"control_textbox"},{"description":"","name":"budgetRange","qid":"38","subLabel":"","text":"Interests","type":"control_textbox"}]);}, 20); 
</script>
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/stylebuilder/static/form-common.css?v=44bc35e
"/>
<style type="text/css">@media print{*{-webkit-print-color-adjust: exact !important;color-adjust: exact !important;}.form-section{display:inline!important}.form-pagebreak{display:none!important}.form-section-closed{height:auto!important}.page-section{position:initial!important}}</style>
    ...
    <link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/themes/CSS/5e6b428acc8c4e222d1beb91.css?v=4.1.76084&themeRevisionID=5eb3b4ae85bd2e1e2966db96"/>
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/s/static/83beb411155/css/styles/payment/payment_styles.css?4.1.76084" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/s/static/83beb411155/css/styles/payment/payment_feature.css?4.1.76084" />
...
/* 29 - FORM COLUMNS */
  ...
  .appointmentCalendarContainer .currentDate {
    background-image: url("data:image/svg+xml;base64,");
  }
  ...
  .supernova body {
    ...
    /*PREFERENCES STYLE*//*__INSPECT_SEPERATOR__*/#input_25{
  ...
  gap:8px;
  background:linear-gradient(to right,#0F6F7D,#798E5C);
}
...
<form class="jotform-form" onsubmit="return typeof testSubmitFunction !== 'undefined' && testSubmitFunction();" action="https://submit.jotform.com/submit/262263209178459" method="post" name="form_262263209178459" id="262263209178459" accept-charset="utf-8" autocomplete="on"><input type="hidden" name="formID" value="262263209178459" /><input type="hidden" id="JWTContainer" value="" /><input type="hidden" id="cardinalOrderNumber" value="" /><input type="hidden" id="jsExecutionTracker" name="jsExecutionTracker" value="build-date-1786793603264" /><input type="hidden" id="submitSource" name="submitSource" value="unknown" /><input type="hidden" id="submitDate" name="submitDate" value="undefined" /><input type="hidden" id="buildDate" name="buildDate" value="1786793603264" /><input type="hidden" name="uploadServerUrl" value="https://upload.jotform.com/upload" /><input type="hidden" name="eventObserver" value="1" />
  <div role="main" class="form-all">
    <ul class="form-section page-section" role="presentation">
      <li id="cid_1" class="form-input-wide" data-type="control_head">
        <div class="form-header-group header-large">
          <div class="header-text httac htvam">
            <h1 id="header_1" class="form-header" data-component="header">Welcome Travel Republic Maldives</h1>
            <div id="subHeader_1" class="form-subHeader">Trip Request Form</div>
          </div>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_fullname" id="id_3"><label class="form-label form-label-top form-label-auto" id="label_3" for="first_3"> Full Name<span class="form-required" aria-hidden="true">*</span> </label>
        <div id="cid_3" class="form-input-wide jf-required" data-layout="full">
          <div aria-labelledby="label_3" role="group" data-wrapper-react="true"><span class="form-sub-label-container" style="vertical-align:top" data-input-type="first"><input type="text" id="first_3" name="q3_fullName3[first]" class="form-textbox validate[required]" data-defaultvalue="" autoComplete="section-input_3 given-name" size="10" data-component="first" aria-labelledby="sublabel_3_first" required="" value="" /><label class="form-sub-label" for="first_3" id="sublabel_3_first" style="min-height:13px">First Name</label></span><span class="form-sub-label-container" style="vertical-align:top" data-input-type="last"><input type="text" id="last_3" name="q3_fullName3[last]" class="form-textbox validate[required]" data-defaultvalue="" autoComplete="section-input_3 family-name" size="15" data-component="last" aria-labelledby="sublabel_3_last" required="" value="" /><label class="form-sub-label" for="last_3" id="sublabel_3_last" style="min-height:13px">Last Name</label></span></div>
        </div>
      </li>
      <li class="form-line form-line-column form-col-1" data-type="control_email" id="id_6"><label class="form-label form-label-top form-label-auto" id="label_6" for="input_6"> E-mail </label>
      ...
      <li class="form-line form-line-column form-col-2 jf-required" data-type="control_phone" id="id_5"><label class="form-label form-label-top form-label-auto" id="label_5" for="input_5_full"> Phone Number With Country Code<span class="form-required" aria-hidden="true">*</span> </label>
        <div id="cid_5" class="form-input-wide jf-required" data-layout="half"> <span class="form-sub-label-container" style="vertical-align:top"><input type="tel" id="input_5_full" name="q5_phoneNumber5[full]" data-type="mask-number" class="mask-phone-number form-textbox validate[required, Fill Mask]" data-defaultvalue="" autoComplete="section-input_5 tel-national" style="width:310px" data-masked="true" placeholder="(000) 000-0000" data-component="phone" aria-label="Phone Number With Country Code" aria-labelledby="label_5 input_5_full_label" required="" value="" /></span><span id="input_5_full_label" style="border:0;clip:rect(0 0 0 0);height:1px;margin:-1px;overflow:hidden;padding:0;position:absolute;width:1px;white-space:nowrap">Format: (000) 000-0000.</span> </div>
      </li>
      <li class="form-line form-line-column form-col-3" data-type="control_textbox" id="id_31"><label class="form-label form-label-top" id="label_31" for="input_31"> Country / Region </label>
        <div id="cid_31" class="form-input-wide" data-layout="half"> <span class="form-sub-label-container" style="vertical-align:top"><input type="text" id="input_31" name="q31_typeA" data-type="input-textbox" class="form-textbox" data-defaultvalue="" style="width:310px" size="310" data-component="textbox" aria-labelledby="label_31 sublabel_input_31" value="" /><label class="form-sub-label" for="input_31" id="sublabel_input_31" style="min-height:13px">Country</label></span> </div>
      </li>
      <li class="form-line form-line-column form-col-4 jf-required" data-type="control_datetime" id="id_32"><span class="form-label form-label-top" id="label_32"> Travel Dates<span class="form-required" aria-hidden="true">*</span> </span>
        <div id="cid_32" class="form-input-wide jf-required" data-layout="half">
          <div data-wrapper-react="true" role="group" aria-labelledby="label_32">
            <div style="display:none"><span class="form-sub-label-container" style="vertical-align:top"><input class="form-textbox validate[required, disallowPast, limitDate]" id="month_32" name="q32_date[month]" type="tel" size="2" data-maxlength="2" data-age="" maxLength="2" required="" autoComplete="off" aria-labelledby="label_32 sublabel_32_month" value="" /><span class="date-separate" aria-hidden="true"> -</span><label class="form-sub-label" for="month_32" id="sublabel_32_month" style="min-height:13px">Month</label></span><span class="form-sub-label-container" style="vertical-align:top"><input class="form-textbox validate[required, disallowPast, limitDate]" id="day_32" name="q32_date[day]" type="tel" size="2" data-maxlength="2" data-age="" maxLength="2" required="" autoComplete="off" aria-labelledby="label_32 sublabel_32_day" value="" /><span class="date-separate" aria-hidden="true"> -</span><label class="form-sub-label" for="day_32" id="sublabel_32_day" style="min-height:13px">Day</label></span><span class="form-sub-label-container" style="vertical-align:top"><input class="form-textbox validate[required, disallowPast, limitDate]" id="year_32" name="q32_date[year]" type="tel" size="4" data-maxlength="4" data-age="" maxLength="4" required="" autoComplete="off" aria-labelledby="label_32 sublabel_32_year" value="" /><label class="form-sub-label" for="year_32" id="sublabel_32_year" style="min-height:13px">Year</label></span></div><span class="form-sub-label-container" style="vertical-align:top"><input class="form-textbox validate[required, disallowPast, limitDate, validateLiteDate]" id="lite_mode_32" type="text" size="12" data-maxlength="12" maxLength="12" data-age="" aria-labelledby="label_32 sublabel_32_litemode" required="" data-format="mmddyyyy" data-seperator="-" placeholder="MM-DD-YYYY" data-placeholder="MM-DD-YYYY" autoComplete="off" value="" /><button type="button" class=" newDefaultTheme-dateIcon focusable icon-liteMode" id="input_32_pick" data-component="datetime" aria-label="Choose date" aria-controls="calendar_32" aria-haspopup="dialog" aria-expanded="false" data-allow-time="No" data-version="v2"></button><label class="form-sub-label" for="lite_mode_32" id="sublabel_32_litemode" style="min-height:13px">Date</label></span>
          </div>
        </div>
      </li>
      <li class="form-line form-line-column form-col-5 jf-required" data-type="control_dropdown" id="id_33"><label class="form-label form-label-top" id="label_33" for="input_33"> Number of Travelers<span class="form-required" aria-hidden="true">*</span> </label>
        <div id="cid_33" class="form-input-wide jf-required" data-layout="half"> <span class="form-sub-label-container" style="vertical-align:top"><select class="form-dropdown validate[required]" id="input_33" name="q33_typeA33" style="width:310px" data-ui-version="v2" data-visible-options="10" data-search-visibility="Auto" data-component="dropdown" required="" aria-label="Number of Travelers">
              <option value="" selected="">Please Select</option>
              <option value="1">1</option>
              <option value="2">2</option>
              <option value="3">3</option>
              <option value="4">4</option>
            </select><label class="form-sub-label" for="input_33" id="sublabel_input_33" style="min-height:13px">Adults</label></span> </div>
      </li>
      <li class="form-line form-line-column form-col-6" data-type="control_dropdown" id="id_34"><label class="form-label form-label-top" id="label_34" for="input_34"> </label>
        <div id="cid_34" class="form-input-wide" data-layout="half"> <span class="form-sub-label-container" style="vertical-align:top"><select class="form-dropdown" id="input_34" name="q34_typeA34" style="width:310px" data-ui-version="v2" data-visible-options="10" data-search-visibility="Auto" data-component="dropdown" aria-label="">
              <option value="" selected="">Please Select</option>
              <option value="1">1</option>
              <option value="2">2</option>
              <option value="3">3</option>
            ...
            </select><label class="form-sub-label" for="input_34" id="sublabel_input_34" style="min-height:13px">Kids</label></span> </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_35"><label class="form-label form-label-top form-label-auto" id="label_35" for="input_35"> Kids Age </label>
        <div id="cid_35" class="form-input-wide" data-layout="half"> <span class="form-sub-label-container" style="vertical-align:top"><input type="text" id="input_35" name="q35_typeA35" data-type="input-textbox" class="form-textbox" data-defaultvalue="" style="width:310px" size="310" data-component="textbox" aria-labelledby="label_35 sublabel_input_35" value="" /><label class="form-sub-label" for="input_35" id="sublabel_input_35" style="min-height:13px">Kids Age (comma separated, e.g. 5,7,10)</label></span> </div>
      </li>
      ...
      <li class="form-line form-line-column form-col-1 jf-required" data-type="control_dropdown" id="id_8"><label class="form-label form-label-top form-label-auto" id="label_8" for="input_8"> Accommodation type<span class="form-required" aria-hidden="true">*</span> </label>
        <div id="cid_8" class="form-input-wide jf-required" data-layout="half"> <select class="form-dropdown validate[required]" id="input_8" name="q8_howDid8" style="width:310px" data-component="dropdown" required="" aria-label="Accommodation type">
            <option value="">Please Select</option>
            <option value="Beach Villa">Beach Villa</option>
            <option value="Water Villa">Water Villa</option>
          </select> </div>
      </li>
      <li class="form-line form-line-column form-col-2" data-type="control_dropdown" id="id_36"><label class="form-label form-label-top" id="label_36" for="input_36"> Meal Plan </label>
        <div id="cid_36" class="form-input-wide" data-layout="half"> <select class="form-dropdown" id="input_36" name="q36_typeA36" style="width:310px" data-ui-version="v2" data-visible-options="10" data-search-visibility="Auto" data-component="dropdown" aria-label="Meal Plan">
            <option value="" selected="">Please Select</option>
      ...
      <li class="form-line form-line-column form-col-3" data-type="control_textbox" id="id_37"><label class="form-label form-label-top" id="label_37" for="input_37"> Budget range </label>
        <div id="cid_37" class="form-input-wide" data-layout="half"> <input type="text" id="input_37" name="q37_typeA37" data-type="input-textbox" class="form-textbox" data-defaultvalue="" style="width:310px" size="310" placeholder="$100000" data-component="textbox" aria-labelledby="label_37" value="" /> </div>
      </li>
      <li class="form-line form-line-column form-col-4" data-type="control_textbox" id="id_38"><label class="form-label form-label-top" id="label_38" for="input_38"> Interests </label>
        <div id="cid_38" class="form-input-wide" data-layout="half"> <input type="text" id="input_38" name="q38_budgetRange" data-type="input-textbox" class="form-textbox" data-defaultvalue="" style="width:310px" size="310" data-component="textbox" aria-labelledby="label_38" value="" /> </div>
      </li>
  ...
  </script><input type="hidden" class="simple_spc" id="simple_spc" name="simple_spc" value="262263209178459" />
  <script type="text/javascript">
    var all_spc = document.querySelectorAll("form[id='262263209178459'] .si" + "mple" + "_spc");
    for (var i = 0; i < all_spc.length; i++)
    {
      all_spc[i].value = "262263209178459-262263209178459";
    }
  </script>
</form>
