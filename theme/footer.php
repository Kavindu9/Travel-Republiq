                    ...
                    <div class="lg:w-[45%] w-full">
                        <div class="footer-contact-card">
                            <h4 class="font-body font-normal text-2xl md:text-xl text-white footer-contact-title">CONTACT US</h4>
                                    ...
                                    <div class="ci-text">
                                        <div class="ci-label font-body text-xl font-normal uppercase">Location</div>
                                        <address class="ci-value font-body text-lg font-normal not-italic">
                                ...
                                <div class="contact-item">
                                    ...
                                    <div class="ci-text">
                                        <div class="ci-label font-body text-xl font-normal uppercase">Email Address</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 font-body text-xl font-normal"> 
                                            <a href="<?php the_field('whatsapp', 'option'); ?>" class="whatsapp-btn flex flex-row gap-2 items-center" target="_blank">
                                                ...
                                                <span class="font-body text-base font-normal">Chat on <br>WhatsApp</span>
                                            </a>
                                        </div>
                                        <div class="col-6 font-body text-xl font-normal"> 
                                            <a href="<?php the_field('telegram', 'option'); ?>" class="whatsapp-btn flex flex-row gap-2 items-center" target="_blank">
                                                ...
                                                <span class="font-body text-base font-normal">Chat on <br>Telegram</span>
                                            </a>
                                        </div>
                                    </div>
...
<!-- **********************  Mailchimp Embed Start *********************** -->
        ...
        <style type="text/css">
            ...
            .mc-field-group .inputfield_form {
        ...
        <div id="mc_embed_signup2">
            <form action="https://gmail.us8.list-manage.com/subscribe/post?u=d8fac9cf57d9c1a02f67019cd&amp;id=f1b29da710&amp;f_id=00c304e1f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank">
                <div id="mc_embed_signup_scroll">
                    <div class="form-row">
                        <div class="mc-field-group">
                            <label for="mce-FNAME" class="font-body text-base font-normal">First Name <span class="asterisk">*</span></label>
                            <input type="text" name="FNAME" class="required text inputfield_form" id="mce-FNAME" required="" value="">
                        </div>
                        <div class="mc-field-group">
                            <label for="mce-LNAME" class="font-body text-base font-normal">Last Name <span class="asterisk">*</span></label>
                    ...
                    <div aria-hidden="true" style="position: absolute; left: -5000px;">
                        <input type="text" name="b_d8fac9cf57d9c1a02f67019cd_f1b29da710" tabindex="-1" value="">
                    </div>
                    <div class="optionalParent" style="margin-top: 15px;">
                        <div class="clear foot row">
                            <input type="submit" name="subscribe" id="mc-embedded-subscribe" class="button submit_btn" value="Subscribe">
                            <div class="col-6 font-body text-xl font-normal"> 
                            <a href="<?php the_field('whatsapp', 'option'); ?>" class="whatsapp-btn flex flex-row gap-2 items-center" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#FFFFFF" class="bi bi-whatsapp" viewBox="0 0 16 16">
                                    <path d="M13.601 2.326A7.85 7.85 0 0 0 7.994 0C3.627 0 .068 3.558.064 7.926c0 1.399.366 2.76 1.057 3.965L0 
