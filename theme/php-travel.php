...
<section class="lg:py-12 py-6">
    <div class="max-w-screen-lg mx-auto px-4">
        ...
        <h5 class="text-2xl md:text-xl font-normal text-[#24846b] mb-8text-center"><?php echo esc_html( get_field('main_subtitle') ); ?></h5>
        ...
        <div class="max-w-screen-lg mx-auto px-4">
            ...
            <div class="lg:grid lg:grid-cols-3 flex gap-4">
                <?php foreach( $galimages as $image ): ?>
                    <div class="h-full">
                        <img src="<?php echo esc_url($image['url']); ?>" class="w-full h-full object-cover rounded-[28px] min-h-[200px]" />
                    </div>
                <?php endforeach; ?>
            </div>
